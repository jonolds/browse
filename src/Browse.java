...
/* TRIPLES ======================================================= */
		...
		class L3Conf implements PairFlatMapFunction<Tuple2<Tuple2<Tuple2<Integer, Integer>, Integer>, Integer>, Tuple2<Tuple2<Integer, Integer>, Integer>, Double> {
			public Iterator<Tuple2<Tuple2<Tuple2<Integer, Integer>, Integer>, Double>> call(Tuple2<Tuple2<Tuple2<Integer, Integer>, Integer>, Integer> t)	throws Exception {
				List<Tuple2<Tuple2<Tuple2<Integer, Integer>, Integer>, Double>> list = new ArrayList<>();
				...
				/*ADD i*/list.add(new Tuple2<>(new Tuple2<>(new Tuple2<>(j, k), i), Double.valueOf(t._2)/j_k_sup));
				/*ADD j*/list.add(new Tuple2<>(new Tuple2<>(new Tuple2<>(i, k), j), Double.valueOf(t._2)/i_k_sup));
				/*ADD k*/list.add(new Tuple2<>(new Tuple2<>(new Tuple2<>(i, j), k), Double.valueOf(t._2)/i_j_sup));
				return list.iterator();
			}
